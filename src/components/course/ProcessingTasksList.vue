      ...
      <div class="text item">
        <el-row>
          <el-col>
            ...
            <el-row v-if="false">
              <el-col>
                <el-input placeholder="请输入学习任务题目进行查询" v-model="searchKeyword" class="input-with-select">
                  <!-- <el-select v-model="select" style="width:95px;" slot="prepend" placeholder="请选择">
                    <el-option label="教师" value="1"></el-option>
                    <el-option label="题目" value="2"></el-option>
                  </el-select> -->
                  <el-button @click="searchTasks" slot="append" icon="el-icon-search"></el-button>
                </el-input>
              </el-col>
            </el-row>
            <!-- 显示查询结果和建议加入的学生信息 -->
